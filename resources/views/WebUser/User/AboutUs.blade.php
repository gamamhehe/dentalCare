...
<div class="row" >
   <div class="col-sm-8 push-sm-2 text-xs-center Bacsititle"> 
      <h3 style="text-align: center;"><span style="font-size: 120%; color: blue;">Nha khoa GOLD Clinic</span></h3>
...
<div class="row">
    <div class="col-md-7 col-sm-12 col-lg-7">
        ...
        <div style=" padding: 7px 0 7px 25px;margin:0;position: relative;font-size: 15px; ">
            <h3 style="text-align: left;"><span style="font-size: 25px; color: #000000;font-family: "UTM AvoBold";"> <strong>Chúng tôi dùng khoa học để làm đẹp tận tâm</strong></span></h3>
