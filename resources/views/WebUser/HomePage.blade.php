		...
		<div class="col-sm-3">
			<div class="daubep">
				...
				<div class="duoi text-xs-center">
					...
					<p class="" style="text-align:justify;">Quí khách có thể đặt hẹn bằng cách liên hệ trực tiếp nha khoa hoặc để lại thông tin tại khung chat hỗ trợ. Nhân viên chúng tôi sẽ liên hệ và tư vấn<a href="#"> ... </a></p>
				</div>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="daubep">
				...
				<div class="duoi text-xs-center">
					...
					<p class="" style="text-align:justify;">Đến tại phòng nha, quí khác sẽ được tư vấn và thăm khám miễn phí về tình trạng răng<a href="#"> ... </a></p>
				</div>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="daubep">
				...
				<div class="duoi text-xs-center">
					...
					<p class="" style="text-align:justify;">Với thiết bị hiện đại và kinh nghiệm lâu năm của các nha sĩ, quí khách có thể biết được chính xác tình trạng răng và cách điều trị<a href="#"> ... </a></p>
				</div>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="daubep">
				...
				<div class="duoi text-xs-center">
					...
					<p class="" style="text-align:justify;">Sau khi tiến hành điều trị tại phòng nha. Quí khách sẽ được các nha sĩ theo dõi tình trạng răng cũng như chăm sóc răng định kì<a href="#"> ... </a></p>
