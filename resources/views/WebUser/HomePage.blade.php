        ...
        <div class="container" style="background: url(/assets/images/HomePage/t3-bg.jpg);width: 100%;padding-top: 30px;padding-bottom: 50px;">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s">
                    <div class="daubep">
                        <div class="tren"  >
                            <img src="/assets/images/HomePage/dv1.jpg" class="centerThing img-responsive img-fruid circleBorder" style="max-width: 150px;" >
                        </div>
                 ...
                 <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s">
                    <div class="daubep">
                        <div class="tren"  >
                            <img src="/assets/images/HomePage/dv2.jpg" class="centerThing img-responsive img-fruid circleBorder" style="max-width: 150px;" >
                        </div>
                        <div class="duoi text-xs-center">
                 ...
                 <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s">
                    <div class="daubep">
                        <div class="tren"  >
                            <img src="/assets/images/HomePage/dv3.jpg" class="centerThing img-responsive img-fruid circleBorder" style="max-width: 150px;" >
                        </div>
                        <div class="duoi text-xs-center">
                 ...
                 <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s">
                    <div class="daubep">
                        <div class="tren"  >
                            <img src="/assets/images/HomePage/dv4.jpg" class="centerThing img-responsive img-fruid circleBorder" style="max-width: 150px;">
                        </div>
                        <div class="duoi text-xs-center">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s">
                    <div class="daubep">
                        <div class="tren"  >
                            <img src="/assets/images/HomePage/dv5.jpg" class="centerThing img-responsive img-fruid circleBorder" style="max-width: 150px;">
                        </div>
                        <div class="duoi text-xs-center">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.1s">
                    <div class="daubep">
                        <div class="tren"  >
                            <img src="/assets/images/HomePage/dv6.jpg" class="centerThing img-responsive img-fruid circleBorder" style="max-width: 150px;">
                        </div>
                        <div class="duoi text-xs-center">
