                    ...
                    <div class="row" style="margin-bottom: 1em;">
                     ...
                     <div class="row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-sm-10" style="padding-right: 0;padding-left: 0">
                            <textarea  type="text" class="form-control input-width" id="description" name="description" placeholder="Lí do" required="required" id="" cols="30" rows="10"></textarea>
                        </div>

                    </div>
                    <div class=""  style="margin-top: 1em;">
                        <button type="button" class="col-md-3 btn btn-default btn-success" style="margin-right: 10px;float: right;"  onclick="validateQuestionBeforeCreate(event,this)" id="createQForm" >Gửi Đơn</button>
                    </div>
