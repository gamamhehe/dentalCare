...
<div class="content-wrapper">
      ...
      <div class="panel-body">
        <div class="form-group row add">
            ...
            <div class="col-sm-6" style="padding-left: 0px;" >
             <input type="text" value="{{$patient->name}}" name="name" class="form-control pull-right" id="startdate" style="margin:0px;" disabled />
         </div>
     </div> 
     <div class="form-group row add">
        <div class="col-sm-2"><label>Địa chỉ</label></div> 
        <div class="col-sm-6" style="padding-left: 0px;" >
         <input type="text" value="{{$patient->address}}" name="name" class="form-control pull-right" id="startdate" style="margin:0px;" disabled />
     </div>
     <div class="col-sm-1"><label>Giới tính</label></div> 
     <div class="col-sm-3" style="padding-left: 0px;" >
         <input type="text" value="{{$patient->gender}}" name="name" class="form-control pull-right" id="startdate" style="margin:0px;" disabled />
     </div>
 ...
 <div class="col-sm-4" style="padding-left: 0px;" >
     <input type="text" value="{{$patient->date_of_birth}}" name="name" class="form-control pull-right" id="startdate" style="margin:0px;" disabled />
 </div>
</div> 
<div class="form-group row add">
                ...
                <div class="article-title">
                    <div class="row">
                        <h4 class="panel-title">
                            <div class="container">
                                <h4 ><i style="position: relative; top: 5px;left: 5px;"></i>{{$treatmentHistory->treatment->name}}</h4>
                            </div>
                            <div class="container">
