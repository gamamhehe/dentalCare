                    ...
                    <div class="box box-info">
                        <div class="col-xs-6">
                            <div class="box-header with-border box-info">
                                ...
                                <a href="/admin/create-treatment/{{$patient->id}}" class="btn btn-success btn-sm" style="float: right;"> Tạo mới liệu trình
                                </a>
                            </div>
                            <div class="panel-body">
                                <div class="form-group row add">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="container">
                            ...
                            <div class="panel-group" id="accordion">
                                ...
                                @if($listTreatmentHistory)
                                    @foreach($listTreatmentHistory as $treatmentHistory)
                                        <div class="panel panel-default">
                                                ...
                                                <h4 class="panel-title">
                                                    <div class="container">
                                                        <a class="accordion-toggle" data-toggle="collapse"
                                                           ...
                                                           href="#collapse{{$treatmentHistory->treatment->id}}">{{$treatmentHistory->treatment->name}} </a>
                                                    </div>
                                                    <div class="container">
                                            ...
                                            <div id="collapse{{$treatmentHistory->treatment->id}}"
                                ...
                                @else
                                    <div class="container"
                                         style="background-color: whitesmoke;width: 100%;height: 200px;">
                                        <h1 style="text-align: center;margin-top: 2em;">Bệnh nhân chưa từng điều
                                            trị</h1>
                                    </div>
                                @endif
                            </div>
