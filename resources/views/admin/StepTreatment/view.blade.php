    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="">
                ...
                <form method="post" class="form-horizontal" action="create-Step" enctype="multipart/form-data"
                      id="createAnamnesis">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                @foreach($list as $one)
                                    <div class="row" style="margin-bottom: 1em;border-bottom: 1px">
                                        ...
                                        <div class="col-sm-4" style="padding-right: 0;">
                                            <input type="checkbox" name="{{$one->id}}" checked data-toggle="toggle"
                            ...
                            <div class="col-sm-6">
                                <div class="row" id="divImage" style="height: 150px;max-height: 150px;">
                                    <!-- ==== -->
    ...
    <script>
        ...
        function addImage() {
            ...
            document.getElementById('divImage').insertAdjacentHTML('beforeend',
                "<div id='" + tmpId + "'class='col-lg-3 col-sm-4 col-xs-6'><a title='Image 1' href='#'><img class='thumbnail img-responsive' src='" + src + "'></a><button type='button' onclick='removeDiv(\"" + tmpId + "\")'>xóa</button></div>");
        }
