       ...
       <div class="content-wrapper">
            <!-- Content Header (Page header) -->
                <div class="box" style="border: none">
                    ...
                    <form method="post" class="form-horizontal" action="create-treatment-detail" enctype="multipart/form-data"
                          id="createAnamnesis">
                        {{ csrf_field() }}
                        <div class="form-group row"  >
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                <div class="row" style="color: green;text-align: center;border-bottom: 1px green solid;    margin-right: 1em"><h3>Các bước điều trị</h3></div>
                                        ...
                                        <div class="row" style="text-align: center;">
                                            <div class="panel-body col-md-6 col-sm-12 col-xs-12">
                                                <div class="box" style="border-top:green 3px solid">
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group row">
                                                            <div class="col-xs-12"><input type="text" name="search" id="search"
                                                                   class="form-control" placeholder="Tên thuốc"/></div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered">
                                                                <thead>
                                                                <tr>
                                                                    <th class="col-md-5 col-xs-12">Tên thuốc</th>
