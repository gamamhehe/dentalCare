        ...
        <section class="content">
            <div class="">
                <div class="row" style="text-align: center;">
                    <label><h1>Cập nhật chi tiết lần khám </h1></label>
...
background-repeat: no-repeat;">
                            ...
                            <div class="col-sm-6">
                              @foreach($listStep as $one)
                                        ...
                                        @if($one->status == "OFF")
                                            ...
                                            <div class="col-sm-4" style="padding-right: 0;">
                                            <input type="checkbox"   data-toggle="toggle"   value="{{$one->id}}"  name="step[]" 
                                                   data-size="mini" data-style="slow" data-onstyle="success"
                                                   data-offstyle="danger" data-on="" data-off="">
                                            </div>
                                             </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <button type="submit" class="col-md-3 btn btn-default btn-success"
                                    ...
                                    onclick="validateQuestionBeforeCreate(event,this)" id="createQForm">Cập nhật
                            </button>
                        </div>
                    </div>
    ...
    font-size: 48px;">Đơn Thuốc</h1></label>
            ...
            <!-- end popup -->
            <input type="hidden" name="idTreatmentHistory" value="{{$idTreatmentHistory}}">
            <input type="hidden" name="idTreatmentDetail" value="{{$idTreatmentDetail}}">
            </form><!-- form tong -->
        </section>
    </div>
    <!-- popup -->
